...
s.kJ(null,new A.R(B.aU,p,t.zK),q,null)
return s},
tD(a){return A.xk(a)},
...
return new A.oC(s,r,null,1+Math.max(q.length,p),new A.R(s,o.h("c(1)").a(new A.oE()),o.h("R<1,c>")).oo(0,B.bm),!A.EC(new A.R(s,o.h("o?(1)").a(new A.oF()),o.h("R<1,o?>"))),new A.ab(""))},
B0(a){var s,r,q
...
EH(a,b,c,d){var s,r=null,q=A.i([],t.dt),p=t.N,o=A.bb(A.BN(r),r,!1,t.kB),n=A.i([-1],t.t),m=A.i([null],t.yE),l=A.x5(a,d),k=new A.q_(new A.qd(!1,b,new A.jC(l,r,a),new A.ag(o,0,0,t.pu),n,m),q,B.bi,A.N(p,t.uj)),j=k.bk(),i=new A.pw(k,A.N(p,t.Fi),j.gB(j)),h=i.iU(0)
if(h==null){q=i.c
return new A.l2(new A.be(r,q),q)}s=i.iU(0)
if(s!=null)throw A.a(A.a0("Only expected one document.",s.b))
return h},
EJ(){A.AC(new A.nK(B.H))
$.mr().hp().b6(0,A.yn())}},J={
...
a3.d=a0
if(r===B.H||q||r===B.I){r=s.querySelector("#console-output-header")
r.toString
...
q.toString
p=k.Q.a
if(p===B.H||p===B.aC){o=s.querySelector(i)
o.toString
n=A.i([o,q],t.k)
...
switch(A.cj(J.aC(t.f.a(B.bA.gnA(t.A_.a(t.B.a(a)))),"index"))){case 0:s=this.a
s.r2=!s.r2
...
while(true)switch(s){case 0:if(b===B.aK)throw A.a(A.Q("Only stable and master channels are supported!",null))
s=3
return A.an(p.c.dr("GET",A.a3(b===B.L?"https://master-api.flutter.dev/snippets/"+a+".dart":"https://api.flutter.dev/snippets/"+a+".dart"),t.n.a(null)),$async$dT)
case 3:o=d
n=o.b
...
else if(c===403)throw A.a(A.e1(B.M,null))
...
throw A.a(A.e1(B.N,"Issue parsing metadata: "+A.l(k)))}else if(t.b.b(c)){j=c
throw A.a(A.e1(B.N,"Issue parsing metadata: "+A.l(j)))}else throw a2}c=A.j(m.c,"files")
h=A.a4(c)
s=4
...
case 3:m=c
if(m.b===404)throw A.a(A.e1(B.N,null))
else{o=p.f.b
if(o===403)throw A.a(A.e1(B.M,null))
...
return p^q}else if(t.R.b(a)){r=B.bo.f8(0,J.bR(a,A.yw(),t.z))
...
q=this.a
p=q.bk()
for(;p.gt(p)!==B.J;){B.b.m(s,this.df(p))
...
case B.Z:return p.mu()
case B.bb:p.a.a2()
return p.hG()
case B.W:return p.hG()
case B.X:return p.mk()
...
n=o.a1()
n.toString}if(s.gt(s)!==B.R&&s.gt(s)!==B.S&&s.gt(s)!==B.T&&s.gt(s)!==B.x){p.hQ()
B.b.m(p.b,B.ag)
p.c=B.bc
o=s.gB(s)
o=A.al(o.a,o.b)
...
return new A.ef(m.c.aB(0,q.gB(q)),m.b,p,B.a0)}if(q instanceof A.dk){if(p==null&&q.c!==B.h)p="!"
k=n.b
if(0>=k.length)return A.e(k,-1)
n.c=k.pop()
l.a2()
return new A.aV(m.c.aB(0,q.a),m.b,p,q.b,q.c)}if(q.gt(q)===B.b8){n.c=B.bh
return new A.ef(m.c.aB(0,q.gB(q)),m.b,p,B.a1)}if(q.gt(q)===B.b5){n.c=B.bg
return new A.e9(m.c.aB(0,q.gB(q)),m.b,p,B.a1)}if(a&&q.gt(q)===B.b7){n.c=B.bd
return new A.ef(m.c.aB(0,q.gB(q)),m.b,p,B.a0)}if(a&&q.gt(q)===B.V){n.c=B.bb
return new A.e9(m.c.aB(0,q.gB(q)),m.b,p,B.a0)}if(m.b!=null||p!=null){l=n.b
...
q.c=p.pop()
return new A.aH(B.J,o.gB(o))}p=o.gB(o)
...
p=A.al(p.a,p.b)
s=p.b
return new A.aH(B.J,A.at(p.a,s,s))}s=o.gB(o)
r=A.al(s.a,s.b)
p.a2()
o=p.a1()
...
q.c=o.pop()
return new A.aH(B.K,n.gB(n))}o=n.gB(n)
...
s.a2()
return new A.e9(r.gB(r),null,null,B.a1)}else if(r.gt(r)!==B.y){B.b.m(p.b,B.ak)
return p.bE()}}s.a2()
s=p.b
if(0>=s.length)return A.e(s,-1)
p.c=s.pop()
...
p=l.mH()
if(p!=null){s=l.f
s.ax(s.$ti.h("ag.E").a(p))}return}if(l.dd(3)){if(s.at(0,"---")){l.hf(B.T)
...
B.bD=new A.c4(32e3)
B.aB=new A.c4(6e7)
B.H=new A.eT("flutter")
B.aC=new A.eT("html")
B.bE=new A.eT("inline")
B.I=new A.eT("flutter_showcase")
...
B.aM=new A.da(B.a3,null)
B.a4=new A.eY("contentNotFound")
B.aN=new A.da(B.a4,null)
...
B.aY=new A.ai(3,{dart:B.bI,html:B.bJ,flutter:B.bK},B.c8,A.ax("ai<b,eU>"))
B.bL=new A.eX("error")
B.a9=new A.e_([B.aI,"flash-warn",B.bL,"flash-error",B.aJ,"flash-success"],A.ax("e_<eX,b>"))
B.d8=new A.ki("")
