...
p.bl(a)
s=p.b|=4
if((s&1)!==0)p.gcB().bR(B.a_)
else if((s&3)===0)p.h2().m(0,B.a_)
...
return A.iP(a,b,c,B.P,!0)}if(d==null)return null
s=new A.a9("")
r.a=""
...
if(s!=null){A.hX(B.a2,new A.pl(s))
return!0}return!1},
...
q.toString
p=k.Q.a
if(p===B.H||p===B.aB){o=s.querySelector(i)
o.toString
n=A.k([o,q],t.k)
...
l=s.querySelector(g)
l.removeAttribute(f)
n=A.k([o,l],q)}m=!0}if(p===B.I){s=s.querySelector(i)
...
s=3
return A.al(p.c.dl("GET",A.a1(b===B.L?"https://master-api.flutter.dev/snippets/"+a+".dart":"https://api.flutter.dev/snippets/"+a+".dart"),t.n.a(null)),$async$dP)
case 3:o=d
n=o.b
...
throw A.a(A.e_(B.N,"Issue parsing metadata: "+A.l(j)))}else throw a2}c=A.i(m.c,"files")
h=A.a3(c)
s=4
...
q=this.a
p=q.bi()
for(;p.gt(p)!==B.J;){B.b.m(s,this.da(p))
...
case B.Z:return p.m6()
case B.ba:p.a.a1()
return p.hw()
case B.W:return p.hw()
...
r=A.aj(r.a,r.b)
q=r.b
return new A.aH(B.K,A.as(r.a,q,q))
...
n=o.a0()
n.toString}if(s.gt(s)!==B.R&&s.gt(s)!==B.S&&s.gt(s)!==B.T&&s.gt(s)!==B.x){p.hG()
B.b.m(p.b,B.af)
p.c=B.bb
o=s.gB(s)
o=A.aj(o.a,o.b)
...
q=p.hG()
s=o.a0()
if(s.gt(s)!==B.T)throw A.a(A.a_("Expected document start.",s.gB(s)))
B.b.m(p.b,B.af)
p.c=B.bd
o.a1()
...
return new A.ec(m.c.aB(0,q.gB(q)),m.b,p,B.a0)}if(q instanceof A.dj){if(p==null&&q.c!==B.h)p="!"
k=n.b
if(0>=k.length)return A.e(k,-1)
n.c=k.pop()
l.a1()
return new A.aU(m.c.aB(0,q.a),m.b,p,q.b,q.c)}if(q.gt(q)===B.b7){n.c=B.bg
return new A.ec(m.c.aB(0,q.gB(q)),m.b,p,B.a1)}if(q.gt(q)===B.b4){n.c=B.bf
return new A.e6(m.c.aB(0,q.gB(q)),m.b,p,B.a1)}if(a&&q.gt(q)===B.b6){n.c=B.bc
return new A.ec(m.c.aB(0,q.gB(q)),m.b,p,B.a0)}if(a&&q.gt(q)===B.V){n.c=B.ba
return new A.e6(m.c.aB(0,q.gB(q)),m.b,p,B.a0)}if(m.b!=null||p!=null){l=n.b
...
p=A.aj(p.a,p.b)
s=p.b
return new A.aH(B.J,A.as(p.a,s,s))}s=o.gB(o)
r=A.aj(s.a,s.b)
p.a1()
o=p.a0()
if(o.gt(o)===B.A||o.gt(o)===B.l||o.gt(o)===B.m||o.gt(o)===B.q){q.c=B.Z
p=r.b
...
o.a1()
n=o.a0()
if(n.gt(n)===B.l||n.gt(n)===B.m||n.gt(n)===B.q){q.c=B.X
o=r.b
return new A.aU(A.as(r.a,o,o),p,p,"",B.h)}else{B.b.m(q.b,B.X)
return q.cr(!0,!0)}}if(n.gt(n)===B.m){q.c=B.X
o=n.gB(n)
o=A.aj(o.a,o.b)
s=o.b
...
s.a1()
return new A.e6(r.gB(r),null,null,B.a1)}else if(r.gt(r)!==B.y){B.b.m(p.b,B.aj)
return p.bC()}}s.a1()
s=p.b
if(0>=s.length)return A.e(s,-1)
p.c=s.pop()
...
s=p.a0()
if(s.gt(s)!==B.p&&s.gt(s)!==B.z){B.b.m(r.b,B.Y)
...
p=l.mj()
if(p!=null){s=l.f
s.ax(s.$ti.h("af.E").a(p))}return}if(l.d8(3)){if(s.at(0,"---")){l.h6(B.T)
return}if(s.at(0,"...")){l.h6(B.U)
...
l.eE(s.cy,B.V,A.aj(s.f,s.c))}l.z=r.length===1
l.bA(B.l)}return
...
B.bC=new A.c2(32e3)
B.aA=new A.c2(6e7)
B.H=new A.eS("flutter")
B.aB=new A.eS("html")
B.bD=new A.eS("inline")
B.I=new A.eS("flutter_showcase")
...
B.J=new A.bR("sequenceEnd")
B.aG=new A.bR("mappingStart")
B.K=new A.bR("mappingEnd")
B.aH=new A.eW("warn")
...
B.M=new A.eX("rateLimitExceeded")
B.aN=new A.d9(B.M,null)
B.N=new A.eX("invalidExerciseMetadata")
B.bR=new A.jR(null)
B.bS=new A.jS(null)
B.bT=new A.jV(!1,255)
B.aO=new A.jW(255)
...
B.bK=new A.eW("error")
B.a8=new A.dY([B.aH,"flash-warn",B.bK,"flash-error",B.aI,"flash-success"],A.aw("dY<eW,b>"))
B.d0=new A.ki("")
