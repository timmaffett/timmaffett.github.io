...
e=A.wx()
s=6
return A.am(h.b0("format",f,e,g,t.e0).dZ(0,B.aB),$async$bX)
case 6:k=a0
h=A.i(n.c,"busyLight")
h.b=0
h.cw()
...
break
case 2:s=4
return A.am(q.f.mV("Show solution?",'If you just want a hint, click <span style="font-weight:bold">Cancel</span> and then <span style="font-weight:bold">Hint</span>.',"Cancel","Show solution",B.aA,B.az),$async$bO)
...
c=A.wh()
s=10
return A.am(d.b0("compileDDC",b,c,a,t.qp).dZ(0,B.aC),$async$as)
case 10:j=a8
d=l.giD()
...
c=A.wj()
s=12
return A.am(d.b0("compile",b,c,a,t.CX).dZ(0,B.aC),$async$as)
case 12:i=a8
d=l.giD()
a5.a(A.a8().a0(B.i)).fH("action-perf","compilation-e2e",d)
A.i(m.aP,"consoleExpandController").am(0)
...
B.a8=A.j(s(["A::href","AREA::href","BLOCKQUOTE::cite","BODY::background","COMMAND::icon","DEL::cite","FORM::action","IMG::src","INPUT::src","INS::cite","Q::cite","VIDEO::poster"]),t.s)
...
B.a9=new A.ao(4,{stable:"https://stable.api.dartpad.dev/",beta:"https://beta.api.dartpad.dev/",old:"https://old.api.dartpad.dev/",dev:"https://dev.api.dartpad.dev/"},B.ck,t.hD)
...
B.cp=new A.ao(3,{whenOpening:!0,whenClosing:!0,indentTags:B.a7},B.c_,t.gU)
