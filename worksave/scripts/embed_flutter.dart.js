...
p.bn(a)
s=p.b|=4
if((s&1)!==0)p.gcE().bT(B.a0)
else if((s&3)===0)p.hb().m(0,B.a0)
...
return A.iQ(a,b,c,B.Q,!0)}if(d==null)return null
s=new A.ab("")
r.a=""
...
if(s!=null){A.fl(B.a3,new A.pn(s))
return!0}return!1},
...
q.toString
p=k.Q.a
if(p===B.I||p===B.aC){o=s.querySelector(i)
o.toString
n=A.i([o,q],t.k)
...
l=s.querySelector(g)
l.removeAttribute(f)
n=A.i([o,l],q)}m=!0}if(p===B.J){s=s.querySelector(i)
...
s=3
return A.an(p.c.dq("GET",A.a3(b===B.M?"https://master-api.flutter.dev/snippets/"+a+".dart":"https://api.flutter.dev/snippets/"+a+".dart"),t.n.a(null)),$async$dS)
case 3:o=d
n=o.b
...
else if(c===403)throw A.a(A.e1(B.N,null))
...
throw A.a(A.e1(B.O,"Issue parsing metadata: "+A.l(k)))}else if(t.b.b(c)){j=c
throw A.a(A.e1(B.O,"Issue parsing metadata: "+A.l(j)))}else throw a2}c=A.j(m.c,"files")
h=A.a4(c)
s=4
...
case 3:m=c
if(m.b===404)throw A.a(A.e1(B.O,null))
else{o=p.f.b
if(o===403)throw A.a(A.e1(B.N,null))
...
q=this.a
p=q.bk()
for(;p.gt(p)!==B.K;){B.b.m(s,this.de(p))
...
case B.a_:return p.mt()
case B.bb:p.a.a2()
return p.hF()
case B.X:return p.hF()
case B.Y:return p.mj()
...
case B.Z:return p.mo()
case B.aj:return p.mp()
case B.bf:return p.hI(!0)
default:throw A.a("Unreachable")}},
mn(){var s,r,q,p=this,o=p.a,n=o.a1()
n.toString
for(s=n;s.gt(s)===B.V;s=n){o.a2()
n=o.a1()
n.toString}if(s.gt(s)!==B.S&&s.gt(s)!==B.T&&s.gt(s)!==B.U&&s.gt(s)!==B.x){p.hP()
B.b.m(p.b,B.ag)
p.c=B.bc
o=s.gB(s)
o=A.al(o.a,o.b)
...
q=p.hP()
s=o.a1()
if(s.gt(s)!==B.U)throw A.a(A.a0("Expected document start.",s.gB(s)))
B.b.m(p.b,B.ag)
p.c=B.be
o.a2()
return A.wk(r.aB(0,s.gB(s)),!1,q.b,q.a)},
ml(){var s,r,q=this,p=q.a.a1()
switch(p.gt(p)){case B.S:case B.T:case B.U:case B.V:case B.x:s=q.b
if(0>=s.length)return A.e(s,-1)
q.c=s.pop()
s=p.gB(p)
s=A.al(s.a,s.b)
...
if(b&&q.gt(q)===B.A){n.c=B.a_
return new A.ef(m.c.aB(0,q.gB(q)),m.b,p,B.a1)}if(q instanceof A.dk){if(p==null&&q.c!==B.h)p="!"
k=n.b
if(0>=k.length)return A.e(k,-1)
n.c=k.pop()
l.a2()
return new A.aV(m.c.aB(0,q.a),m.b,p,q.b,q.c)}if(q.gt(q)===B.b8){n.c=B.bh
return new A.ef(m.c.aB(0,q.gB(q)),m.b,p,B.a2)}if(q.gt(q)===B.b5){n.c=B.bg
return new A.e9(m.c.aB(0,q.gB(q)),m.b,p,B.a2)}if(a&&q.gt(q)===B.b7){n.c=B.bd
return new A.ef(m.c.aB(0,q.gB(q)),m.b,p,B.a1)}if(a&&q.gt(q)===B.W){n.c=B.bb
return new A.e9(m.c.aB(0,q.gB(q)),m.b,p,B.a1)}if(m.b!=null||p!=null){l=n.b
...
q.c=p.pop()
return new A.aI(B.K,o.gB(o))}p=o.gB(o)
...
p=A.al(p.a,p.b)
s=p.b
return new A.aI(B.K,A.at(p.a,s,s))}s=o.gB(o)
r=A.al(s.a,s.b)
p.a2()
o=p.a1()
if(o.gt(o)===B.A||o.gt(o)===B.m||o.gt(o)===B.n||o.gt(o)===B.t){q.c=B.a_
p=r.b
return new A.aV(A.at(r.a,p,p),null,null,"",B.h)}else{B.b.m(q.b,B.a_)
return q.dh(!0)}},
...
o.a2()
n=o.a1()
if(n.gt(n)===B.m||n.gt(n)===B.n||n.gt(n)===B.t){q.c=B.Y
o=r.b
return new A.aV(A.at(r.a,o,o),p,p,"",B.h)}else{B.b.m(q.b,B.Y)
return q.cu(!0,!0)}}if(n.gt(n)===B.n){q.c=B.Y
o=n.gB(n)
o=A.al(o.a,o.b)
s=o.b
...
s.a2()
return new A.e9(r.gB(r),null,null,B.a2)}else if(r.gt(r)!==B.y){B.b.m(p.b,B.ak)
return p.bE()}}s.a2()
s=p.b
if(0>=s.length)return A.e(s,-1)
p.c=s.pop()
...
s=p.a1()
if(s.gt(s)!==B.r&&s.gt(s)!==B.z){B.b.m(r.b,B.Z)
...
r=l
q=null
while(!0){if(!(r.gt(r)===B.S||r.gt(r)===B.T))break
...
p=l.mG()
if(p!=null){s=l.f
s.ax(s.$ti.h("ag.E").a(p))}return}if(l.dc(3)){if(s.at(0,"---")){l.hf(B.U)
return}if(s.at(0,"...")){l.hf(B.V)
...
l.eJ(s.cy,B.W,A.al(s.f,s.c))}l.z=r.length===1
l.bC(B.m)}return
...
B.bD=new A.c4(32e3)
B.aB=new A.c4(6e7)
B.I=new A.eT("flutter")
B.aC=new A.eT("html")
B.bE=new A.eT("inline")
B.J=new A.eT("flutter_showcase")
...
B.N=new A.eY("rateLimitExceeded")
B.aO=new A.da(B.N,null)
B.O=new A.eY("invalidExerciseMetadata")
B.bS=new A.jR(null)
B.bT=new A.jS(null)
B.bU=new A.jV(!1,255)
B.aP=new A.jW(255)
...
B.P=A.i(s([0,0,32776,33792,1,10240,0,0]),t.t)
...
B.Q=A.i(s([0,0,65490,45055,65535,34815,65534,18431]),t.t)
