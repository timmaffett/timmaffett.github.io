...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      if (savedMarkdown != null && savedMarkdown.length !== 0 && savedMarkdown !== _s24959_) {
  ...
  A.ListSyntax.prototype = {
    ...
    parse$1(parser) {
      var endItem, match, tryMatch, t1, t2, t3, listMarker, indent, startNumber, t4, t5, t6, leadingExpandedTabLength, line, digits, t7, firstWhitespace, restWhitespace, $content, markerAsSpaces, itemNodes, anyEmptyLines, anyEmptyLinesBetweenBlocks, _i, itemParser, children, i, child, _this = this, _box_0 = {},
      ...
      for (t1 = parser.lines, t2 = match._name, t3 = type$.Pattern, listMarker = null, indent = null, startNumber = null; t4 = parser._pos, t5 = t1.length, t4 < t5;) {
        ...
        if (A.boolConversionCheck(tryMatch.call$1(t5))) {
          ...
          break;
        else if (A.boolConversionCheck(tryMatch.call$1($.$get$ulPattern())) || A.boolConversionCheck(tryMatch.call$1($.$get$olPattern()))) {
          t4 = match._value;
          if (t4 === match)
          ...
          endItem.call$0();
          B.JSArray_methods.add$1(_box_0.childLines, restWhitespace + $content);
          listMarker = t7;
      ...
      for (t1 = items.length, t2 = parser.document, t3 = type$.String, anyEmptyLinesBetweenBlocks = false, _i = 0; _i < items.length; items.length === t1 || (0, A.throwConcurrentModificationError)(items), ++_i) {
        itemParser = A.BlockParser$(items[_i].lines, t2);
        B.JSArray_methods.add$1(itemNodes, new A.Element("li", itemParser.parseLines$0(), A.LinkedHashMap_LinkedHashMap$_empty(t3, t3)));
      ...
      if (_this.get$listTag() === "ol" && startNumber !== 1) {
        ...
        return new A.Element(_this.get$listTag(), itemNodes, A.LinkedHashMap_LinkedHashMap$_empty(t3, t3));
    },
  ...
  (function inheritance() {
    ...
    _inheritMany(A.InlineSyntax, [A.AutolinkExtensionSyntax, A.AutolinkSyntax, A.CodeSyntax, A.DelimiterSyntax, A.EmailAutolinkSyntax, A.EmojiSyntax, A.EscapeSyntax, A.TextSyntax, A.LineBreakSyntax]);
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "ExtensionSet_gitHubWeb", "$get$ExtensionSet_gitHubWeb", () => A.ExtensionSet$(A.List_List$unmodifiable(A._setArrayType([B.C_FencedCodeBlockSyntax, B.C_HeaderWithIdSyntax, B.C_SetextHeaderWithIdSyntax, B.C_TableSyntax], type$.JSArray_BlockSyntax), type$.BlockSyntax), A.List_List$unmodifiable(A._setArrayType([A.InlineHtmlSyntax$(), new A.StrikethroughSyntax(true, true, A._setArrayType([A.DelimiterTag$("del", 2)], type$.JSArray_DelimiterTag), A.RegExp_RegExp("~+", true, true), null), new A.EmojiSyntax(A.RegExp_RegExp(":([a-z0-9_+-]+):", true, true), null), new A.AutolinkExtensionSyntax(A.RegExp_RegExp("(?:^|[\\s*_~(>])(((?:(?:https?|ftp):\\/\\/|www\\.))([\\w\\-][\\w\\-.]+)([^\\s<]*))", true, true), null)], type$.JSArray_InlineSyntax), type$.InlineSyntax)));
