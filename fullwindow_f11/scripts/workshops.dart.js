...
nk(a){var s=a.a,r=s.F("getOption",["fullScreen"])
s.F("setOption",["fullScreen",!A.cb(r==null?!1:r)])},
...
A.xK("toggleFullWindowOnOff",m.gnj())
m=A.yN(m,s)
l=m.e.a
l.F(q,["theme","darkpad"])
l.F(q,["mode","dart"])
...
m=A.aq(m.a,m.b)
l=m.b
n.eI(new A.dO("!","!"),A.az(m.a,l,l),!0)
l=r.gE(r)
l=A.aq(l.a,l.b)
m=l.b
n.eI(new A.dO("!!","tag:yaml.org,2002:"),A.az(l.a,m,m),!0)
...
B.cl=new A.aK(3,{info:B.cf,warning:B.cg,error:B.ce},B.cd,A.aw("aK<b,j<b>>"))
...
B.bZ=A.f(s(["Cmd-/","Ctrl-/","F11","Tab"]),t.s)
B.ck=new A.aK(4,{"Cmd-/":"toggleComment","Ctrl-/":"toggleComment",F11:"toggleFullWindowOnOff",Tab:"insertSoftTab"},B.bZ,t.hD)
B.c4=A.f(s(["completeSingle"]),t.s)
B.cq=new A.aK(1,{completeSingle:!1},B.c4,t.y5)
B.cn=new A.aK(12,{continueComments:B.cm,autofocus:!1,autoCloseBrackets:!0,matchBrackets:!0,tabSize:2,lineWrapping:!1,indentUnit:2,cursorHeight:0.85,viewportMargin:100,extraKeys:B.ck,hintOptions:B.cq,scrollbarStyle:"simple"},B.c1,A.aw("aK<b,l>"))
...
s($,"IZ","vW",()=>B.f.fX(new A.vF(),A.aw("af<C>")))
s($,"I_","B6",()=>A.de(A.rE({
