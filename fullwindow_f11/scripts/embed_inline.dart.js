...
B.ck=new A.av(3,{info:B.ce,warning:B.cf,error:B.cd},B.cc,A.au("av<b,h<b>>"))
...
B.bY=A.k(s(["Cmd-/","Ctrl-/","F11","Tab"]),t.s)
B.cj=new A.av(4,{"Cmd-/":"toggleComment","Ctrl-/":"toggleComment",F11:"toggleFullWindowOnOff",Tab:"insertSoftTab"},B.bY,t.hD)
B.c4=A.k(s(["completeSingle"]),t.s)
B.co=new A.av(1,{completeSingle:!1},B.c4,t.y5)
B.E=new A.av(12,{continueComments:B.cl,autofocus:!1,autoCloseBrackets:!0,matchBrackets:!0,tabSize:2,lineWrapping:!1,indentUnit:2,cursorHeight:0.85,viewportMargin:100,extraKeys:B.cj,hintOptions:B.co,scrollbarStyle:"simple"},B.c1,A.au("av<b,o>"))
