...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    FlowChartConfig: function FlowChartConfig() {
    },
    SequenceDiagramConfig: function SequenceDiagramConfig() {
    },
    GnattConfig: function GnattConfig() {
    },
    ...
    _renderMarkdown($event) {
      ...
      mermaid.init(null, "code.language-mermaid");
      if ($event != null)
  ...
  A.FlowChartConfig.prototype = {};
  A.SequenceDiagramConfig.prototype = {};
  A.GnattConfig.prototype = {};
  A.Config.prototype = {};
  ...
  (function inheritance() {
    ...
    _inheritMany(J.LegacyJavaScriptObject, [J.PlainJavaScriptObject, J.UnknownJavaScriptObject, J.JavaScriptFunction, A.FlowChartConfig, A.SequenceDiagramConfig, A.GnattConfig, A.Config]);
