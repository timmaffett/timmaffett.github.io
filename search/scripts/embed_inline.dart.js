...
B.cl=new A.ap(3,{info:B.cf,warning:B.cg,error:B.ce},B.cd,A.ax("ap<b,f<b>>"))
...
B.aW=new A.ap(12,{macctrl:"\u2303",alt:"\u2325",shift:"\u21e7",ctrl:"\u2318",esc:"\u238b",left:"\u2190",enter:"\u21a9",right:"\u2192",caps_lock:"\u21ea",tab:"\u21e5",up:"\u2191",space:"Space"},B.c3,A.ax("ap<@,@>"))
B.cr=new A.ap(0,{},B.D,t.hD)
B.ca=A.j(s([]),A.ax("E<ek>"))
B.aX=new A.ap(0,{},B.ca,A.ax("ap<ek,@>"))
...
B.cm=new A.ap(1,{continueLineComment:!1},B.c5,t.y5)
B.bZ=A.j(s(["whenOpening","whenClosing","indentTags"]),t.s)
B.co=new A.ap(3,{whenOpening:!0,whenClosing:!0,indentTags:B.a5},B.bZ,t.gU)
B.c2=A.j(s(["Cmd-/","Ctrl-/","Shift-Tab","Tab","Cmd-F","Cmd-H","Ctrl-F","Ctrl-H","Cmd-G","Shift-Ctrl-G","Ctrl-G","Shift-Cmd-G","F4","Shift-F4"]),t.s)
B.cq=new A.ap(14,{"Cmd-/":"toggleComment","Ctrl-/":"toggleComment","Shift-Tab":"indentLess",Tab:u.m,"Cmd-F":"weHandleElsewhere","Cmd-H":"weHandleElsewhere","Ctrl-F":"weHandleElsewhere","Ctrl-H":"weHandleElsewhere","Cmd-G":"weHandleElsewhere","Shift-Ctrl-G":"weHandleElsewhere","Ctrl-G":"weHandleElsewhere","Shift-Cmd-G":"weHandleElsewhere",F4:"weHandleElsewhere","Shift-F4":"weHandleElsewhere"},B.c2,t.hD)
...
B.cs=new A.ap(14,{continueComments:B.cm,autofocus:!1,autoCloseTags:B.co,autoCloseBrackets:!0,matchBrackets:!0,tabSize:2,lineWrapping:!1,indentUnit:2,cursorHeight:0.85,viewportMargin:100,extraKeys:B.cq,highlightSelectionMatches:B.cp,hintOptions:B.ct,scrollbarStyle:"simple"},B.cc,t.gU)
B.c6=A.j(s(["dart","html","flutter"]),t.s)
B.bH=new A.eU("dart")
B.bI=new A.eU("html")
B.bJ=new A.eU("flutter")
B.aY=new A.ap(3,{dart:B.bH,html:B.bI,flutter:B.bJ},B.c6,A.ax("ap<b,eU>"))
B.bK=new A.eX("error")
