...
A.et.prototype={
kF(a){var s
if($.il.gL($.il)){for(s=0;s<262;++s)$.il.k(0,B.bZ[s],A.Es())
...
q.a(A.a8().a0(B.l)).bf(B.c1,new A.o9(r),"Completion")
q.a(A.a8().a0(B.l)).bf(B.c3,new A.oa(r),"Quick fix")
q.a(A.a8().a0(B.l)).bf(B.c_,new A.ob(r),"Format")
q=document
q.toString
s=t.hm.a(r.glz())
t.Z.a(null)
...
B.cn=new A.ap(3,{info:B.cg,warning:B.ch,error:B.cf},B.ce,A.ax("ap<b,f<b>>"))
B.cj=A.j(s(["sender","type"]),t.s)
B.cp=new A.ap(2,{sender:"frame",type:"ready"},B.cj,t.hD)
...
B.co=new A.ap(1,{continueLineComment:!1},B.c6,t.y5)
B.c0=A.j(s(["whenOpening","whenClosing","indentTags"]),t.s)
B.cq=new A.ap(3,{whenOpening:!0,whenClosing:!0,indentTags:B.a5},B.c0,t.gU)
B.bY=A.j(s(["Cmd-/","Ctrl-/","Shift-Tab","Tab","Cmd-F","Cmd-H","Ctrl-F","Ctrl-H","F4","Shift-F4"]),t.s)
B.cm=new A.ap(10,{"Cmd-/":"toggleComment","Ctrl-/":"toggleComment","Shift-Tab":"indentLess",Tab:u.m,"Cmd-F":"weHandleElsewhere","Cmd-H":"weHandleElsewhere","Ctrl-F":"weHandleElsewhere","Ctrl-H":"weHandleElsewhere",F4:"weHandleElsewhere","Shift-F4":"weHandleElsewhere"},B.bY,t.hD)
B.cl=A.j(s(["style","showToken","annotateScrollbar"]),t.s)
B.cr=new A.ap(3,{style:"highlight-selection-matches",showToken:!1,annotateScrollbar:!0},B.cl,t.gU)
B.c5=A.j(s(["completeSingle"]),t.s)
B.cu=new A.ap(1,{completeSingle:!1},B.c5,t.y5)
B.ct=new A.ap(14,{continueComments:B.co,autofocus:!1,autoCloseTags:B.cq,autoCloseBrackets:!0,matchBrackets:!0,tabSize:2,lineWrapping:!1,indentUnit:2,cursorHeight:0.85,viewportMargin:100,extraKeys:B.cm,highlightSelectionMatches:B.cr,hintOptions:B.cu,scrollbarStyle:"simple"},B.cd,t.gU)
