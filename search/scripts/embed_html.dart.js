...
s=J.cG(a)
if(s===B.bO||s===B.bQ||t.qF.b(a)){r=B.at(a)
q=r!=="Object"&&r!==""
if(q)return r
p=a.constructor
...
m=A.fH(B.bp,A.fH(B.bq,A.fH(B.au,A.fH(B.au,A.fH(B.br,A.fH(B.bs,A.fH(B.bt(B.at),m)))))))
...
break}}B.b.m(j,r)
m=r+1
if((j.length&1)===1)a=B.ap.o8(a,m,s)
...
r.toString
s=t.xH
s=new A.aP(new A.b7(B.ao.aV(r,a,b,c)),s.h("u(h.E)").a(new A.nF()),s.h("aP<h.E>"))
...
return B.f.aA(0,B.aq.aj(A.fK(s,"\n","")))},
mn(a){var s
...
A.ha.prototype={
gA(a){var s=this.$ti
return new A.hb(J.a3(this.a),this.b,B.ar,s.h("@<1>").u(s.Q[1]).h("hb<1,2>"))}}
A.hb.prototype={
...
lO(){var s=window
s.toString
B.ac.nd(s,"message",new A.nO(this))},
...
if(r==null)r="stable"
if(J.j3(B.a8.gD(B.a8),r)){s=t.x.a(A.a8().a0(B.u))
q=B.a8.i(0,r)
q.toString
...
q.toString
p=l.Q.a
if(p===B.a1||p===B.a2){s=s.querySelector("#editor-and-console-container")
s.toString
o=A.j([s,q],t.pX)
n=!0}else{q=t.pX
...
e=A.wv()
s=6
return A.am(h.b_("format",f,e,g,t.e0).dY(0,B.aA),$async$cp)
case 6:k=a0
h=A.i(n.c,"busyLight")
h.b=0
h.cv()
...
r.toString
r=A.a2(r).ga_().i(0,"id")
B.ac.ob(p,s,"DartPad_"+A.l(A.eE(r)?r:""))
return null},
$S:1}
A.o3.prototype={
...
break
case 2:s=4
return A.am(q.f.mQ("Show solution?",'If you just want a hint, click <span style="font-weight:bold">Cancel</span> and then <span style="font-weight:bold">Hint</span>.',"Cancel","Show solution",B.az,B.ay),$async$bN)
...
lP(){var s=window
s.toString
B.ac.eV(s,"message",new A.oc(this),!1)},
$iAH:1}
A.oc.prototype={
...
c=a1.a(l)
b=A.w5()
j=a0.b_("analyze",c,b,a1,t.ye).dY(0,B.aA)
m.snf(j)
p=4
s=7
...
c=A.wf()
s=10
return A.am(d.b_("compileDDC",a,c,b,t.qp).dY(0,B.aB),$async$as)
case 10:j=a8
d=l.giz()
...
c=A.wh()
s=12
return A.am(d.b_("compile",a,c,b,t.CX).dY(0,B.aB),$async$as)
case 12:i=a8
d=l.giz()
a5.a(A.a8().a0(B.i)).fF("action-perf","compilation-e2e",d)
A.i(m.y2,"consoleExpandController").am(0)
...
case 3:d=a4
c=d.b
if(c===404)throw A.a(A.e0(B.a4,null))
else if(c===403)throw A.a(A.e0(B.K,null))
else if(c!==200)throw A.a(A.e0(B.a3,null))
...
else if(o!==200)throw A.a(A.e0(B.a3,null))}q=A.yv(A.mn(J.ay(A.mj(m.e).c.a,"charset")).aA(0,m.x))
s=1
break
case 1:return A.aZ(q,r)}})
return A.b_($async$$1,r)},
...
i+=j.eO(a+"  ")
h.a=i
h.a=i+(a+"}\n")}else{if(p.b(j))j=B.aY.fC(j,0,B.as)
h.a+=a+A.l(n)+": "+A.l(j)+"\n"}}}s=h.a
return s.charCodeAt(0)==0?s:s},
ar(){if(this.b)return
...
gR(a){return A.fi(B.aa.bR(this.a.c,this.b,this.c),0,null)},
gaK(){var s=this,r=s.a,q=s.c,p=r.ce(q)
if(r.e2(q)===0&&p!==0){if(q-s.b===0)return p===r.b.length-1?"":A.fi(B.aa.bR(r.c,r.cY(p),r.cY(p+1)),0,null)}else q=p===r.b.length-1?r.c.length:r.cY(p+1)
return A.fi(B.aa.bR(r.c,r.cY(r.ce(s.b)),q),0,null)},
...
case B.ak:return p.mm()
case B.bi:return p.mn()
case B.am:return p.mo()
case B.al:p.c=B.ak
r=p.a.a1()
r=r.gB(r)
r=A.ak(r.a,r.b)
...
o=A.ak(o.a,o.b)
n=o.b
return A.wl(A.at(o.a,n,n),!0,null,null)}if(s.gt(s)===B.x){p.c=B.ai
o.a2()
...
s.a2()
return new A.e8(r.gB(r),null,null,B.a_)}else if(r.gt(r)!==B.y){B.b.m(p.b,B.ak)
return p.bD()}}s.a2()
s=p.b
if(0>=s.length)return A.e(s,-1)
p.c=s.pop()
...
B.aL=new A.d9(B.a3,null)
B.a4=new A.eY("contentNotFound")
B.aM=new A.d9(B.a4,null)
