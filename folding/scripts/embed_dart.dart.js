...
q[r]=c.a(a.i(0,r))}return new A.ai(p,q,o,b.h("@<0>").u(c).h("ai<1,2>"))}return new A.dS(A.jZ(a,b,c),b.h("@<0>").u(c).h("dS<1,2>"))},
...
""+q.a
return J.A4(a,new A.jM(B.cC,0,s,r,0))},
By(a,b,c){var s,r,q
...
eF(a){if(a==null||typeof a!="object")return J.ap(a)
else return A.ea(a)},
...
if(B.G===c){s=J.ap(a)
b=J.ap(b)
return A.uY(A.dm(A.dm($.ux(),s),b))}if(B.G===d){s=J.ap(a)
b=J.ap(b)
c=J.ap(c)
return A.uY(A.dm(A.dm(A.dm($.ux(),s),b),c))}s=J.ap(a)
b=J.ap(b)
c=J.ap(c)
d=J.ap(d)
r=$.ux()
...
if(b===c)return""
if(!A.xE(B.a.w(a,b)))A.fD(a,b,"Scheme not starting with alphabetic character")
...
A6(a,b,c){return J.fJ(a).jc(a,b,c)},
...
q.h("1/").a(a)
if(q.h("aj<1>").b(a))if(q.b(a))A.rI(a,r)
else r.fZ(a)
else{s=r.dl()
q.c.a(a)
r.a=8
...
return this.l7(a,0,r)}}return A.fj(a,0,r)},
...
gau(a){return this.e}}
A.tn.prototype={
$1(a){return A.vi(B.ck,A.t(a),B.f,!1)},
$S:6}
A.tq.prototype={
...
return p},
skI(a){this.c=this.$ti.h("fU<1>").a(a)}}
A.mM.prototype={
$0(){this.a.e=!0},
$S:13}
A.c2.prototype={
...
f8(a,b){var s,r
this.$ti.h("d<1>?").a(b)
for(s=b.gA(b),r=0;s.n();){r=r+J.ap(s.gq())&2147483647
...
o.toString
A.ao(a2.id,"solutionTab")
a2.id=new A.az(o)
o=s.querySelector("#navbar")
o.toString
A.ao(a2.fy,"navBarElement")
a2.fy=new A.az(o)
o=t.y0
...
g.toString
g=A.a2(g).ga_().i(0,"theme")==="dark"?"frame_dark.html":"frame.html"
B.bO.sjR(d.d,g)
d.e=g
A.ao(a2.r,a9)
a2.r=d
...
A.ao(a2.d,"analysisResultsController")
a2.d=a
...
h=A.a2(h).ga_().i(0,"id")
s=10
return A.an(a0.dR(A.eE(h)?h:""),$async$aT)
case 10:k=a4
s=8
break
...
if(h==null)h=""
s=14
return A.an(a0.dS(h,j),$async$aT)
case 14:k=a4
s=12
break
case 13:a0=l
...
e.toString
s=15
return A.an(a0.cP(h,f,A.a2(e).ga_().i(0,"gh_ref"),g),$async$aT)
case 15:k=a4
...
break
case 19:s=22
return A.an(m.x.bE("Error loading gist","No gist was found for the gist ID, sample ID, or repository information provided.","","OK",B.v,B.p,!1),$async$aT)
case 22:s=20
break
case 21:s=i.a===B.K?23:25
break
case 23:s=26
return A.an(m.x.bE("Error loading files","GitHub's rate limit for API requests has been exceeded. This is typically caused by repeatedly loading a single page that has many DartPad embeds or when many users are accessing DartPad (and therefore GitHub's API server) from a single, shared IP address. Quotas are typically renewed within an hour, so the best course of action is to try back later.","","OK",B.v,B.p,!1),$async$aT)
case 26:s=24
break
...
s=30
return A.an(m.x.bE("Error loading files","DartPad could not load the requested exercise. Either one of the required files wasn't available, or the exercise metadata was invalid.","","OK",B.v,B.p,!1),$async$aT)
case 30:s=28
break
case 29:s=31
return A.an(m.x.bE("Error loading files","An error occurred while the requested files.","","OK",B.v,B.p,!1),$async$aT)
...
e=A.wv()
s=6
return A.an(h.b_("format",f,e,g,t.e0).dY(0,B.az),$async$cp)
case 6:k=a0
h=A.i(n.c,"busyLight")
h.b=0
h.cv()
...
break
case 2:s=4
return A.an(q.f.mS("Show solution?",'If you just want a hint, click <span style="font-weight:bold">Cancel</span> and then <span style="font-weight:bold">Hint</span>.',"Cancel","Show solution",B.ay,B.ax),$async$bN)
case 4:if(d===B.ay)a="editor"
case 3:if(a==="solution"){t.Q.a(A.a8().a0(B.i)).by("view","solution")
q.r=!0}s=5
return A.an(q.ke(a),$async$bN)
case 5:return A.aZ(null,r)}})
...
s.toString
r.sn0(t.i.a(B.o.aA(0,s)))}q.a.k(0,B.cR,r)
return A.hd(null,m)}}
A.ky.prototype={
ba(a,b){var s,r
...
r.a(A.a8().a0(B.l)).bf(A.j(["f4","ctrl-g","macctrl-g"],q),new A.qg(s),"Find Next")
r.a(A.a8().a0(B.l)).bf(A.j(["shift-f4","shift-ctrl-g","shift-macctrl-g"],q),new A.qh(s),"Find Previous")},
...
s=3
return A.an(p.a.cB("POST",l,t.n.a(null),k,B.f),$async$b_)
case 3:o=h
...
return A.an(q.y.jK(0,A.i(q.e,"editor")),$async$d2)
case 2:return A.aZ(null,r)}})
...
a1=A.t(e)
b.a.bA(2,a1)
m.iz(A.j([b],t.e5))}else m.a.o6(B.bW,f,null,null)
...
c=A.wf()
s=10
return A.an(d.b_("compileDDC",a,c,b,t.qp).dY(0,B.aA),$async$as)
case 10:j=a8
d=l.giA()
...
c=A.wh()
s=12
return A.an(d.b_("compile",a,c,b,t.CX).dY(0,B.aA),$async$as)
case 12:i=a8
d=l.giA()
a5.a(A.a8().a0(B.i)).fG("action-perf","compilation-e2e",d)
A.i(m.y2,"consoleExpandController").am(0)
...
a.toString
s=13
return A.an(d.nF(b,a,i.a.a8(0),!1),$async$as)
case 13:case 8:q=!0
n=[1]
s=5
break
...
while(true)switch(s){case 0:s=3
return A.an(p.c.dq("GET",A.a2("https://api.github.com/gists/"+A.l(a)),t.n.a(null)),$async$dR)
case 3:n=c
m=n.b
...
s=3
return A.an(p.c.dq("GET",A.a2(b===B.J?"https://master-api.flutter.dev/snippets/"+a+".dart":"https://api.flutter.dev/snippets/"+a+".dart"),t.n.a(null)),$async$dS)
case 3:o=d
n=o.b
...
h=A.a4(c)
s=4
return A.an(A.wx(new A.P(c,h.h("aj<b>(1)").a(new A.oz(o,a,a1,b,a0,d)),h.h("P<1,aj<b>>")),!0,t.N),$async$cP)
case 4:g=a4
h=A.j([],t.tE)
...
n=p.d+"/"
s=3
return A.an(o.c.dq("GET",o.fY(p.b,p.c,n+(A.i(a.b,"alternatePath").length===0?A.i(a.a,"name"):A.i(a.b,"alternatePath")),p.e),t.n.a(null)),$async$$1)
case 3:m=c
...
s=3
return A.an(new A.eN(A.x6(b.z,t.L)).jg(),$async$ba)
case 3:j=d
...
return(a^A.xm(A.dz(A.dz(0,J.ap(b.a)),J.ap(b.b))))>>>0},
...
q^=q>>>11
q=q+((q&16383)<<15)&536870911}for(s=k.b,r=s.length,p=0;p<s.length;s.length===r||(0,A.ah)(s),++p)q=q+7*J.ap(s[p])&536870911
for(s=k.c,r=s.length,p=0;p<s.length;s.length===r||(0,A.ah)(s),++p)q=q+37*J.ap(s[p])&536870911
for(s=k.d,r=s.length,p=0;p<s.length;s.length===r||(0,A.ah)(s),++p)q=q+53*J.ap(s[p])&536870911
for(s=k.e,r=s.length,p=0;p<s.length;s.length===r||(0,A.ah)(s),++p)q=q+J.ap(s[p])&536870911
return q},
...
$S:124}
A.rX.prototype={
$2(a,b){return A.dz(A.p(a),J.ap(b))},
$S:125}
A.ph.prototype={
...
return r}else if(a instanceof A.be){r=J.ap(a.b)
...
case B.d3:return p.ct(!0,!0)
case B.d2:return p.bD()
case B.bc:p.a.a2()
return p.hG()
case B.ae:return p.hG()
case B.X:return p.mr()
case B.ba:p.a.a2()
return p.hF()
case B.U:return p.hF()
case B.V:return p.mh()
...
n=o.a1()
n.toString}if(s.gt(s)!==B.P&&s.gt(s)!==B.Q&&s.gt(s)!==B.R&&s.gt(s)!==B.x){p.hP()
B.b.m(p.b,B.af)
p.c=B.bb
o=s.gB(s)
o=A.al(o.a,o.b)
...
p=l.mE()
if(p!=null){s=l.f
s.ax(s.$ti.h("ag.E").a(p))}return}if(l.dc(3)){if(s.at(0,"---")){l.hf(B.R)
return}if(s.at(0,"...")){l.hf(B.S)
...
o=p.cx
n=p.cy
B.b.k(l,s-1,new A.ey(r+q,A.al(p.f,p.c),o,n,k))},
...
p(h,"gdg","bq",0)
o(A.fr.prototype,"gnm",0,1,function(){return[null]},["$2","$1"],["c_","cH"],107,0,0)
n(A.I.prototype,"gd5","aJ",22)
p(h=A.cY.prototype,"gdf","bp",0)
p(h,"gdg","bq",0)
p(h=A.as.prototype,"gdf","bp",0)
p(h,"gdg","bq",0)
p(A.fs.prototype,"gmN","dn",0)
...
m(A.f0.prototype,"glK","lL",17)
m(A.k4.prototype,"gmX","i7",70)
m(h=A.fW.prototype,"glH","lI",16)
m(h,"glN","lO",16)
m(h,"gn2","n3",16)
m(h,"gmf","mg",16)
r(A,"Eg","El",6)
p(h=A.h7.prototype,"gnQ","as",81)
m(h,"glz","lA",17)
...
B.ck=A.j(s([0,0,32722,12287,65535,34815,65534,18431]),t.t)
...
B.cl=A.j(s(["sender","type"]),t.s)
B.cr=new A.ai(2,{sender:"frame",type:"ready"},B.cl,t.hD)
...
B.aV=new A.ai(12,{macctrl:"\u2303",alt:"\u2325",shift:"\u21e7",ctrl:"\u2318",esc:"\u238b",left:"\u2190",enter:"\u21a9",right:"\u2192",caps_lock:"\u21ea",tab:"\u21e5",up:"\u2191",space:"Space"},B.c5,A.ax("ai<@,@>"))
B.cx=new A.ai(0,{},B.D,t.hD)
B.cc=A.j(s([]),A.ax("E<ek>"))
B.aW=new A.ai(0,{},B.cc,A.ax("ai<ek,@>"))
B.cm=A.j(s(["stable","beta","old","dev"]),t.s)
B.a7=new A.ai(4,{stable:"https://stable.api.dartpad.dev/",beta:"https://beta.api.dartpad.dev/",old:"https://old.api.dartpad.dev/",dev:"https://dev.api.dartpad.dev/"},B.cm,t.hD)
B.c8=A.j(s(["dart","html","flutter"]),t.s)
B.bI=new A.eV("dart")
B.bJ=new A.eV("html")
B.bK=new A.eV("flutter")
B.aX=new A.ai(3,{dart:B.bI,html:B.bJ,flutter:B.bK},B.c8,A.ax("ai<b,eV>"))
B.bL=new A.eY("error")
B.a8=new A.dZ([B.aH,"flash-warn",B.bL,"flash-error",B.aI,"flash-success"],A.ax("dZ<eY,b>"))
B.co=A.j(s(["continueComments","autofocus","autoCloseTags","autoCloseBrackets","matchBrackets","tabSize","lineWrapping","indentUnit","cursorHeight","viewportMargin","extraKeys","highlightSelectionMatches","hintOptions","scrollbarStyle","foldGutter","foldOptions","matchTags","gutters"]),t.s)
...
B.ct=new A.ai(3,{whenOpening:!0,whenClosing:!0,indentTags:B.a5},B.c_,t.gU)
B.c3=A.j(s(["Cmd-/","Ctrl-/","Shift-Tab","Tab","Cmd-F","Cmd-H","Ctrl-F","Ctrl-H","Cmd-G","Shift-Ctrl-G","Ctrl-G","Shift-Cmd-G","F4","Shift-F4","Shift-Ctrl-[","Cmd-Alt-[","Shift-Ctrl-]","Cmd-Alt-]","Shift-Ctrl-Alt-[","Shift-Cmd-Alt-[","Shift-Ctrl-Alt-]","Shift-Cmd-Alt-]"]),t.s)
...
B.cn=A.j(s(["style","showToken","annotateScrollbar"]),t.s)
B.cw=new A.ai(3,{style:"highlight-selection-matches",showToken:!1,annotateScrollbar:!0},B.cn,t.gU)
B.c6=A.j(s(["completeSingle"]),t.s)
B.cy=new A.ai(1,{completeSingle:!1},B.c6,t.y5)
B.cj=A.j(s(["minFoldSize","widget"]),t.s)
B.cs=new A.ai(2,{minFoldSize:1,widget:"\xb7\xb7\xb7"},B.cj,t.gU)
B.c4=A.j(s(["bothTags"]),t.s)
B.cu=new A.ai(1,{bothTags:!0},B.c4,t.y5)
B.ce=A.j(s(["CodeMirror-linenumbers","CodeMirror-foldgutter"]),t.s)
B.cz=new A.ai(18,{continueComments:B.cq,autofocus:!1,autoCloseTags:B.ct,autoCloseBrackets:!0,matchBrackets:!0,tabSize:2,lineWrapping:!1,indentUnit:2,cursorHeight:0.85,viewportMargin:100,extraKeys:B.cv,highlightSelectionMatches:B.cw,hintOptions:B.cy,scrollbarStyle:"simple",foldGutter:!0,foldOptions:B.cs,matchTags:B.cu,gutters:B.ce},B.co,t.gU)
B.d8=new A.ki("")
B.d=new A.ki("dart_services.api")
B.b_=new A.ed("DOUBLE_QUOTED")
B.cA=new A.ed("FOLDED")
B.cB=new A.ed("LITERAL")
B.h=new A.ed("PLAIN")
...
B.d3=new A.au("BLOCK_NODE_OR_INDENTLESS_SEQUENCE")})();(function staticFields(){$.rZ=null
$.wX=null
$.q6=0
$.uV=A.DC()
$.wc=null
...
s($,"GC","uz",()=>B.e.fo(new A.us(),A.ax("aj<z>")))
s($,"FP","zd",()=>A.cV(A.r_({
