...
break}}B.b.m(j,r)
m=r+1
if((j.length&1)===1)a=B.ap.oa(a,m,s)
...
lQ(){var s=window
s.toString
B.ac.nf(s,"message",new A.nO(this))},
...
e=A.wv()
s=6
return A.an(h.b_("format",f,e,g,t.e0).dY(0,B.aA),$async$cp)
case 6:k=a0
h=A.i(n.c,"busyLight")
h.b=0
h.cv()
...
r.toString
r=A.a2(r).ga_().i(0,"id")
B.ac.od(p,s,"DartPad_"+A.l(A.eE(r)?r:""))
return null},
$S:1}
A.o3.prototype={
...
break
case 2:s=4
return A.an(q.f.mS("Show solution?",'If you just want a hint, click <span style="font-weight:bold">Cancel</span> and then <span style="font-weight:bold">Hint</span>.',"Cancel","Show solution",B.az,B.ay),$async$bN)
...
c=A.wf()
s=10
return A.an(d.b_("compileDDC",a,c,b,t.qp).dY(0,B.aB),$async$as)
case 10:j=a8
d=l.giA()
...
c=A.wh()
s=12
return A.an(d.b_("compile",a,c,b,t.CX).dY(0,B.aB),$async$as)
case 12:i=a8
d=l.giA()
a5.a(A.a8().a0(B.i)).fG("action-perf","compilation-e2e",d)
A.i(m.y2,"consoleExpandController").am(0)
...
i+=j.eO(a+"  ")
h.a=i
h.a=i+(a+"}\n")}else{if(p.b(j))j=B.aY.fD(j,0,B.as)
h.a+=a+A.l(n)+": "+A.l(j)+"\n"}}}s=h.a
return s.charCodeAt(0)==0?s:s},
ar(){if(this.b)return
...
case B.ah:return p.ml()
case B.bd:return p.mj()
case B.ag:return p.mk()
...
case B.ak:return p.mo()
case B.bi:return p.mp()
case B.am:return p.mq()
case B.al:p.c=B.ak
r=p.a.a1()
r=r.gB(r)
r=A.al(r.a,r.b)
...
B.aV=new A.ai(12,{macctrl:"\u2303",alt:"\u2325",shift:"\u21e7",ctrl:"\u2318",esc:"\u238b",left:"\u2190",enter:"\u21a9",right:"\u2192",caps_lock:"\u21ea",tab:"\u21e5",up:"\u2191",space:"Space"},B.c4,A.ax("ai<@,@>"))
B.cw=new A.ai(0,{},B.D,t.hD)
B.cb=A.j(s([]),A.ax("E<ek>"))
B.aW=new A.ai(0,{},B.cb,A.ax("ai<ek,@>"))
B.cl=A.j(s(["stable","beta","old","dev"]),t.s)
B.a8=new A.ai(4,{stable:"https://stable.api.dartpad.dev/",beta:"https://beta.api.dartpad.dev/",old:"https://old.api.dartpad.dev/",dev:"https://dev.api.dartpad.dev/"},B.cl,t.hD)
B.c7=A.j(s(["dart","html","flutter"]),t.s)
B.bH=new A.eU("dart")
B.bI=new A.eU("html")
B.bJ=new A.eU("flutter")
B.aX=new A.ai(3,{dart:B.bH,html:B.bI,flutter:B.bJ},B.c7,A.ax("ai<b,eU>"))
B.bK=new A.eX("error")
...
B.cs=new A.ai(3,{whenOpening:!0,whenClosing:!0,indentTags:B.a6},B.bZ,t.gU)
