...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    LorentzGauss$fromPars(a, c, w, m) {
      var t1 = new A.LorentzGauss(c, w, m, a);
      t1.LorentzGauss$fromPars$6(a, c, w, m, null, null);
      return t1;
    },
    ...
    main() {
      var k, appDiv, plotDiv, plotAttr, xaxisAttr, yaxisAttr, legendAttr,
        height = [100, 100, 100],
        center = [120, 120, 120],
        width = [15, 15, 15],
        lor_array = new Float64Array(200),
        gaus_array = new Float64Array(200),
        mixed_array = new Float64Array(200),
        t1 = type$.JSArray_double,
        lor = A.LorentzGauss$fromPars(height[0], A._setArrayType([center[0]], t1), A._setArrayType([width[0]], t1), A._setArrayType([0], t1)),
        t2 = height[1],
        t3 = center[1],
        t4 = A._setArrayType([t3], t1),
        t5 = width[1],
        gaus = A.LorentzGauss$fromPars(t2, t4, A._setArrayType([t5], t1), A._setArrayType([1], t1)),
        mixed = A.LorentzGauss$fromPars(t2, A._setArrayType([t3], t1), A._setArrayType([t5], t1), A._setArrayType([0.5], t1));
      for (k = 0; k < 200; ++k) {
        t2 = lor.getValueAt$1(A._setArrayType([k], t1));
        if (!(k < 200))
          return A.ioore(lor_array, k);
        lor_array[k] = t2;
        t2 = gaus.getValueAt$1(A._setArrayType([k], t1));
        if (!(k < 200))
          return A.ioore(gaus_array, k);
        gaus_array[k] = t2;
        t2 = mixed.getValueAt$1(A._setArrayType([k], t1));
        if (!(k < 200))
          return A.ioore(mixed_array, k);
        mixed_array[k] = t2;
      }
      t2 = A._setArrayType([lor_array, gaus_array, mixed_array], type$.JSArray_Float64List);
      t3 = document;
      t4 = type$.DivElement;
      ...
      t4.toString;
      t3.width = "" + t4 + "px";
      t4 = appDiv.clientHeight;
      t4.toString;
      t3.height = "" + t4 + "px";
      t3 = type$.PyA;
      t4 = type$.String;
      plotAttr = A._setArrayType([A.LinkedHashMap_LinkedHashMap$_literal([B.PyA_28, "0.8"], t3, t4), A.LinkedHashMap_LinkedHashMap$_literal([B.PyA_28, "0.8"], t3, t4), A.LinkedHashMap_LinkedHashMap$_literal([B.PyA_28, "0.8"], t3, t4)], type$.JSArray_Map_PyA_String);
      t3 = type$.AxA;
      xaxisAttr = A.LinkedHashMap_LinkedHashMap$_literal([B.AxA_10, "0", B.AxA_11, "200", B.AxA_4, "Number of points"], t3, t4);
      yaxisAttr = A.LinkedHashMap_LinkedHashMap$_literal([B.AxA_4, "Function value"], t3, t4);
      t3 = type$.JSArray_String;
      legendAttr = A.LinkedHashMap_LinkedHashMap$_literal([B.LegA_11, "Lorentz / Gauss line shapes", B.LegA_12, B.C_JsonCodec.encode$1(A._setArrayType(["Pure Lorentzian", " Pure Gaussian", " Mixed 50% / 50%"], t3)), B.LegA_8, "45", B.LegA_9, "15"], type$.LegA, t4);
      t1 = A._setArrayType([A._setArrayType([0, 0, 1, 1], t1)], type$.JSArray_List_double);
      t4 = new A.PlotLayoutSVG(plotDiv, t1);
      t4.PlotLayoutSVG$mult$4(plotDiv, false, t1, null);
      new A.SimplePlot(t4, 0, t2, plotAttr, legendAttr, xaxisAttr, yaxisAttr, A._setArrayType(["blue", "red", "magenta", "green", "orange", "cyan", "lightgreen", "crimson", "darkred", "darkgreen"], t3), null).SimplePlot$mult$8(t2, plotAttr, xaxisAttr, yaxisAttr, legendAttr, null, t4, 0);
    }
  },
  J = {
  ...
  A.LorentzGauss.prototype = {
    LorentzGauss$fromPars$6(a, c, w, m, fGauss, fLorentz) {
      ...
      _this.dim = 1;
      _this.set$__LorentzGauss_pars_A(type$.List_double._as(A.List_List$filled(4, 0, type$.double)));
