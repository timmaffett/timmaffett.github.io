...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t2, t3, t4, appDiv, plotDiv, plotAttr, xaxisAttr, yaxisAttr, legendAttr,
        t1 = new A.Sinc1D();
      t1.Sinc1D$5(1000, 100, 0, 8, 0);
      t1 = t1.__Sinc1D__array_A;
      t1 === $ && A.throwLateFieldNI("_array");
      t2 = new A.Sine1D();
      t2.Sine1D$6(2000, 20, 0, 8, 0, 0);
      t2 = t2.__Sine1D__array_A;
      ...
      t3 = type$.PyA;
      t4 = type$.String;
      plotAttr = A._setArrayType([A.LinkedHashMap_LinkedHashMap$_literal([B.PyA_28, "0.8"], t3, t4), A.LinkedHashMap_LinkedHashMap$_literal([B.PyA_28, "0.8"], t3, t4)], type$.JSArray_Map_PyA_String);
      t3 = type$.AxA;
      xaxisAttr = A.LinkedHashMap_LinkedHashMap$_literal([B.AxA_10, "0", B.AxA_11, "8", B.AxA_4, "Number of periods (2*\u03c0)"], t3, t4);
      yaxisAttr = A.LinkedHashMap_LinkedHashMap$_literal([B.AxA_4, "Function value ('intensity')"], t3, t4);
      t3 = type$.JSArray_String;
      legendAttr = A.LinkedHashMap_LinkedHashMap$_literal([B.LegA_11, "Example plot using the class 'SimplePlot'", B.LegA_12, B.C_JsonCodec.encode$1(A._setArrayType(["100 * sin(x) / x", " 20 * sin(x)"], t3)), B.LegA_8, "45", B.LegA_9, "15"], type$.LegA, t4);
      t2 = A._setArrayType([t1, t2], type$.JSArray_Float64List);
      t1 = A._setArrayType([A._setArrayType([0, 0, 1, 1], type$.JSArray_double)], type$.JSArray_List_double);
