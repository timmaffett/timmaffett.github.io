...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    SimplePlot_createLegend(legendAttr, poly_colors) {
      var t4, subtitles, nsubtitles, t5, legend, colors, i, _s6_ = "legend",
      ...
      if (t1 != null && t1.length !== 0) {
        t1.toString;
        legend.initSetText$3("TOP_TITLE_ID", t1, null);
      }
      colors = A.List_List$from(B.JSArray_methods.sublist$2(poly_colors, 0, nsubtitles), t3);
      for (i = nsubtitles - 1; i >= 0; --i) {
        t1 = A._instanceType(subtitles)._rest[1]._as(J.$index$asx(subtitles._source, i));
        if (!(i < colors.length))
          return A.ioore(colors, i);
        legend.setText$3("" + (i + 1), t1, colors[i]);
      }
      return legend;
    },
    ...
    Sine1D$(npoints, amplitude, phase, nperiods, noise, offset) {
      var t1 = new A.Sine1D();
      t1.Sine1D$6(npoints, amplitude, phase, nperiods, noise, offset);
      return t1;
    },
    ...
    main() {
      var t2, t3, t4, dataArrays, plotAttr, xaxisAttr, yaxisAttr, legendAttr, poly_colors, appDiv, plotDiv, pl, i, t5, t6, t7, _null = null, _s6_ = "_array",
        _s16_ = "100 * sin(x) / x",
        _s23_ = "Number of periods (2*\u03c0)",
        t1 = new A.Sinc1D();
      t1.Sinc1D$5(1000, 100, 0, 8, 0);
      t1 = t1.__Sinc1D__array_A;
      t1 === $ && A.throwLateFieldNI(_s6_);
      t2 = A.Sine1D$(2000, 20, 0, 8, 0, 0).__Sine1D__array_A;
      t2 === $ && A.throwLateFieldNI(_s6_);
      t3 = A.Sine1D$(600, 50, 1.5707963, 6, 0, 0).__Sine1D__array_A;
      t3 === $ && A.throwLateFieldNI(_s6_);
      t4 = type$.JSArray_Float64List;
      dataArrays = [A._setArrayType([t1, t2], t4), A._setArrayType([t1], t4), A._setArrayType([t3], t4)];
      plotAttr = A.List_List$filled(3, _null, type$.nullable_List_nullable_Map_PyA_String);
      t4 = type$.nullable_Map_AxA_String;
      xaxisAttr = A.List_List$filled(3, _null, t4);
      yaxisAttr = A.List_List$filled(3, _null, t4);
      legendAttr = A.List_List$filled(3, _null, type$.nullable_Map_LegA_String);
      t4 = type$.PyA;
      t3 = type$.String;
      t1 = type$.JSArray_nullable_Map_PyA_String;
      B.JSArray_methods.$indexSet(plotAttr, 0, A._setArrayType([A.LinkedHashMap_LinkedHashMap$_literal([B.PyA_28, "0.8"], t4, t3), A.LinkedHashMap_LinkedHashMap$_literal([B.PyA_28, "0.8"], t4, t3)], t1));
      B.JSArray_methods.$indexSet(plotAttr, 1, A._setArrayType([A.LinkedHashMap_LinkedHashMap$_literal([B.PyA_28, "0.8"], t4, t3)], t1));
      B.JSArray_methods.$indexSet(plotAttr, 2, A._setArrayType([A.LinkedHashMap_LinkedHashMap$_literal([B.PyA_28, "0.5", B.PyA_24, "0.85", B.PyA_18, "magenta"], t4, t3)], t1));
      t1 = type$.AxA;
      B.JSArray_methods.$indexSet(xaxisAttr, 0, A.LinkedHashMap_LinkedHashMap$_literal([B.AxA_10, "0", B.AxA_11, "8", B.AxA_4, _s23_], t1, t3));
      B.JSArray_methods.$indexSet(xaxisAttr, 1, A.LinkedHashMap_LinkedHashMap$_literal([B.AxA_10, "0", B.AxA_11, "8", B.AxA_4, _s23_], t1, t3));
      B.JSArray_methods.$indexSet(xaxisAttr, 2, A.LinkedHashMap_LinkedHashMap$_literal([B.AxA_10, "0", B.AxA_11, "600", B.AxA_4, "Number of points"], t1, t3));
      B.JSArray_methods.$indexSet(yaxisAttr, 0, A.LinkedHashMap_LinkedHashMap$_literal([B.AxA_4, "Value"], t1, t3));
      B.JSArray_methods.$indexSet(yaxisAttr, 1, A.LinkedHashMap_LinkedHashMap$_literal([B.AxA_4, "Intensity"], t1, t3));
      B.JSArray_methods.$indexSet(yaxisAttr, 2, A.LinkedHashMap_LinkedHashMap$_literal([B.AxA_4, "Pressure"], t1, t3));
      t1 = type$.JSArray_String;
      t4 = type$.LegA;
      B.JSArray_methods.$indexSet(legendAttr, 0, A.LinkedHashMap_LinkedHashMap$_literal([B.LegA_11, "Multi-plot (1) in same div", B.LegA_12, B.C_JsonCodec.encode$1(A._setArrayType([_s16_, " 20 * sin(x)"], t1)), B.LegA_8, "35", B.LegA_9, "15"], t4, t3));
      B.JSArray_methods.$indexSet(legendAttr, 1, A.LinkedHashMap_LinkedHashMap$_literal([B.LegA_11, "Multi-plot (2) in same div", B.LegA_12, B.C_JsonCodec.encode$1(A._setArrayType([_s16_], t1)), B.LegA_8, "35", B.LegA_9, "15"], t4, t3));
      B.JSArray_methods.$indexSet(legendAttr, 2, A.LinkedHashMap_LinkedHashMap$_literal([B.LegA_11, "Multi-plot (3) in same div", B.LegA_12, B.C_JsonCodec.encode$1(A._setArrayType(["50 * cosine(x)"], t1)), B.LegA_8, "35", B.LegA_9, "15"], t4, t3));
      poly_colors = [A._setArrayType(["blue", "red"], t1), A._setArrayType(["darkred"], t1), A._setArrayType(["magenta"], t1)];
      t3 = document;
      t4 = type$.DivElement;
      appDiv = t4._as(t3.querySelector("#app_div"));
      plotDiv = t4._as(t3.querySelector("#plot_div"));
      t3 = plotDiv.style;
      t3.toString;
      t4 = appDiv.clientWidth;
      t4.toString;
      t3.width = "" + t4 + "px";
      ...
      t2 = A._setArrayType([A._setArrayType([0, 0, 0.5, 0.5], t2), A._setArrayType([0.5, 0, 0.5, 0.5], t2), A._setArrayType([0.1, 0.5, 0.7, 0.5], t2)], type$.JSArray_List_double);
      pl = new A.PlotLayoutSVG(plotDiv, t2);
      pl.PlotLayoutSVG$mult$4(plotDiv, false, t2, _null);
      for (i = 0; i < 3; ++i) {
        t2 = dataArrays[i];
        t3 = plotAttr[i];
        t4 = xaxisAttr[i];
        ...
        t6 = legendAttr[i];
        t7 = poly_colors[i];
        new A.SimplePlot(pl, i, t2, t3, t6, t4, t5, A._setArrayType(["blue", "red", "magenta", "green", "orange", "cyan", "lightgreen", "crimson", "darkred", "darkgreen"], t1), t7).SimplePlot$mult$8(t2, t3, t4, t5, t6, t7, pl, i);
      }
    }
  },
  J = {
  ...
  A.PlotLayoutSVG.prototype = {
    PlotLayoutSVG$mult$4(plotDiv, withCanvas, plotSizes, layoutAttr) {
      ...
      _this.set$__PlotLayoutSVG_dataAreas_A(t3._as(A.List_List$filled(3, _null, t2)));
      _this.set$__PlotLayoutSVG_plotAreas_A(t3._as(A.List_List$filled(3, _null, t2)));
      t2 = type$.nullable_RectElement;
      t3 = type$.List_nullable_RectElement;
      _this.set$__PlotLayoutSVG_dataAreaBorders_A(t3._as(A.List_List$filled(3, _null, t2)));
      _this.set$__PlotLayoutSVG_plotAreaBorders_A(t3._as(A.List_List$filled(3, _null, t2)));
      t2 = type$.nullable_Rectangle_int;
      t3 = type$.List_nullable_Rectangle_int;
      _this.set$__PlotLayoutSVG_plotAreaRects_A(t3._as(A.List_List$filled(3, _null, t2)));
      _this.set$__PlotLayoutSVG_dataAreaRects_A(t3._as(A.List_List$filled(3, _null, t2)));
      _this.set$__PlotLayoutSVG_xaxisRects_A(t3._as(A.List_List$filled(3, _null, t2)));
      _this.set$__PlotLayoutSVG_yaxisRects_A(t3._as(A.List_List$filled(3, _null, t2)));
      _this.set$__PlotLayoutSVG_contourCanvases_A(type$.List_nullable_CanvasElement._as(A.List_List$filled(3, _null, type$.nullable_CanvasElement)));
      t2 = type$.int;
      ...
      for (t4 = type$.SvgElement, t5 = type$.RectElement, t6 = type$.SvgSvgElement, t7 = _this.plotSizes, t8 = 2 * borderAreaSize, t9 = 2 * frameSize, i = 0; i < 3; ++i) {
        t10 = t3.clientWidth;
        t10.toString;
        t11 = t7[i];
        plotareaLeft = B.JSNumber_methods.round$0(t10 * t11[0]);
        t12 = t3.clientHeight;
        t12.toString;
        plotareaTop = B.JSNumber_methods.round$0(t12 * t11[1]);
        plotareaWidth = B.JSNumber_methods.round$0(t10 * t11[2] - 2 - t8 - t9);
        plotareaHeight = B.JSNumber_methods.round$0(t12 * t11[3] - 2 - t8 - t9);
  ...
  A.SimplePlot.prototype = {
    SimplePlot$mult$8(arrays, plotAttr, xaxisAttr, yaxisAttr, legendAttr, poly_colors, pl, plotnum) {
      var t1, t2, t3, t4, attr, t5, physWidth, physStart, t6, t7, t8, t9, t10, t11, firstY, lastY, i, _this = this, _null = null,
      ...
      t2 = type$.AxA;
      t3 = type$.String;
      if (_this.xaxisAttr == null) {
        t4 = $.$get$Axis_AXIS_DEFAULT_ATTRIBUTES();
        _this.set$xaxisAttr(A.LinkedHashMap_LinkedHashMap$from(t4, t2, t3));
        _this.xaxisAttr.$indexSet(0, B.AxA_4, "Point number");
      } else {
        t4 = $.$get$Axis_AXIS_DEFAULT_ATTRIBUTES();
        attr = A.LinkedHashMap_LinkedHashMap$from(t4, t2, t3);
        t5 = _this.xaxisAttr;
        t5.toString;
        attr.addAll$1(0, t5);
        _this.set$xaxisAttr(attr);
      }
      if (_this.yaxisAttr == null) {
        _this.set$yaxisAttr(A.LinkedHashMap_LinkedHashMap$from(t4, t2, t3));
        _this.yaxisAttr.$indexSet(0, B.AxA_4, "Function value");
      } else {
        attr = A.LinkedHashMap_LinkedHashMap$from(t4, t2, t3);
        t2 = _this.yaxisAttr;
        t2.toString;
      ...
      if (_this.xaxisAttr.$index(0, B.AxA_10) != null) {
        t4 = _this.xaxisAttr.$index(0, B.AxA_10);
        t4.toString;
        if (J.get$length$asx(t4) !== 0)
          if (_this.xaxisAttr.$index(0, B.AxA_11) != null) {
            t4 = _this.xaxisAttr.$index(0, B.AxA_11);
            t4.toString;
      ...
      if (t4) {
        t4 = _this.xaxisAttr.$index(0, B.AxA_10);
        physStart = A.double_parse(t4 == null ? "0" : t4);
        t4 = _this.xaxisAttr.$index(0, B.AxA_11);
        physWidth = A.double_parse(t4 == null ? "0" : t4);
      } else
        physStart = 0;
      t4 = t1.__Polyline_xValues_A;
      t4 === $ && A.throwLateFieldNI("xValues");
      t4 = B.NativeFloat64List_methods.get$first(t4);
      ...
      t11 = _this.xaxisAttr;
      t11.toString;
      t11 = _this.__SimplePlot_xaxis_A = A.Axis$coord(t2, t4, t5, physStart, physWidth, true, _null, t9, t10, t7, t1.get$xphysToXscreen(), t11, _null);
      t7 = t11.__Axis_labelsContainer_A;
      t7 === $ && A.throwLateFieldNI(_s15_);
      t10 = t6.__PlotLayoutSVG_xaxisRects_A;
      if (!(t8 < t10.length))
        return A.ioore(t10, t8);
      t10 = t10[t8];
      t9 = t10.left;
      t11 = t11.__Axis_extra_space_for_edge_labels_x_A;
      t11 === $ && A.throwLateFieldNI("extra_space_for_edge_labels_x");
      A.SVG_setAttr(t7, A.LinkedHashMap_LinkedHashMap$_literal(["x", "" + (t9 - t11), "y", "" + t10.top], t3, t3));
      t10 = _this.__SimplePlot_xaxis_A.__Axis_xyGrid_A;
      t10 === $ && A.throwLateFieldNI(_s6_);
      t10 = t10.__XYGrid_gridContainer_A;
      t10 === $ && A.throwLateFieldNI(_s13_);
      t11 = t6.__PlotLayoutSVG_dataAreaRects_A;
      if (!(t8 < t11.length))
        return A.ioore(t11, t8);
      t11 = t11[t8];
      A.SVG_setAttr(t10, A.LinkedHashMap_LinkedHashMap$_literal(["x", "" + t11.left, "y", "" + t11.top], t3, t3));
      firstY = t1.yScreenToYphys$1(0);
      t11 = t6.__PlotLayoutSVG_dataAreaRects_A;
      if (!(t8 < t11.length))
        return A.ioore(t11, t8);
      lastY = t1.yScreenToYphys$1(t11[t8].height);
      if (firstY == null) {
      ...
      t2 === $ && A.throwLateFieldNI("yscale");
      t4 = t6.__PlotLayoutSVG_dataAreaRects_A;
      if (!(t8 < t4.length))
      ...
      t9 = _this.yaxisAttr;
      t9.toString;
      t9 = _this.__SimplePlot_yaxis_A = A.Axis$intens(firstY / t2, lastY / t2, _null, _null, _null, t5, t7, t4, t1.get$yphysToYscreen(), t9, _null);
      t1 = t9.__Axis_labelsContainer_A;
      t1 === $ && A.throwLateFieldNI(_s15_);
      t4 = t6.__PlotLayoutSVG_yaxisRects_A;
      if (!(t8 < t4.length))
        return A.ioore(t4, t8);
      t4 = t4[t8];
      t7 = t4.left;
      t4 = t4.top;
      t9 = t9.__Axis_extra_space_for_edge_labels_y_A;
      t9 === $ && A.throwLateFieldNI("extra_space_for_edge_labels_y");
      A.SVG_setAttr(t1, A.LinkedHashMap_LinkedHashMap$_literal(["x", "" + t7, "y", "" + (t4 - t9)], t3, t3));
      t9 = _this.__SimplePlot_yaxis_A.__Axis_xyGrid_A;
      ...
      if (!(t8 < t4.length))
        return A.ioore(t4, t8);
      t4 = t4[t8];
      A.SVG_setAttr(t9, A.LinkedHashMap_LinkedHashMap$_literal(["x", "" + t4.left, "y", "" + t4.top], t3, t3));
      t3 = _this.legendAttr;
      _this.legend = A.SimplePlot_createLegend(t3, _this.poly_colors);
      for (t1 = _this.arrays, i = 0; i < t1.length; ++i) {
        t2 = t6.__PlotLayoutSVG_dataAreas_A;
        t2 === $ && A.throwLateFieldNI(_s9_);
        if (!(t8 < t2.length))
          return A.ioore(t2, t8);
        t2 = t2[t8];
        t2.toString;
        t4 = _this.__SimplePlot_polylines_A;
        if (!(i < t4.length))
          return A.ioore(t4, i);
        t4 = t4[i].__Polyline_polylineContainer_A;
        t4 === $ && A.throwLateFieldNI("polylineContainer");
        t2.appendChild(t4).toString;
      }
      if (t3 != null) {
    ...
    createPolylines$0() {
      var t2, t3, t4, t5, t6, t7, i, t8, t9, attr, t10, t11, t12, t13, t14, _this = this, _null = null,
        _s9_ = "polylines",
        t1 = _this.arrays;
      _this.set$__SimplePlot_polylines_A(type$.List_nullable_Polyline._as(A.List_List$filled(t1.length, _null, type$.nullable_Polyline)));
      for (t2 = _this.pl, t3 = _this.plotnum, t4 = type$.JSArray_GeometryElement, t5 = type$.PyA, t6 = type$.String, t7 = type$.nullable_Map_PyA_String, i = 0; t8 = t1.length, i < t8; ++i) {
        if (i === 0) {
          t9 = _this.plotAttr;
          t9 = t9 == null || t9.length !== t8;
        } else
          t9 = false;
        if (t9)
          _this.set$plotAttr(A.List_List$filled(t8, _null, t7));
        t8 = _this.plotAttr;
        if (!(i < t8.length))
          return A.ioore(t8, i);
        t9 = t8[i];
        if (t9 == null) {
          ...
          t8 = t8[i];
          t8.toString;
          t9 = _this.poly_colors;
          if (!(i < t9.length))
            return A.ioore(t9, i);
          t8.$indexSet(0, B.PyA_18, t9[i]);
        } else {
          ...
          t8 = _this.plotAttr;
          t8.toString;
          B.JSArray_methods.$indexSet(t8, i, attr);
        }
        if (i > 0) {
          t8 = _this.plotAttr;
          if (!(i < t8.length))
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      JSArray_nullable_Map_PyA_String: findType("JSArray<Map<PyA,String>?>"),
      ...
      nullable_Map_LegA_String: findType("Map<LegA,String>?"),
