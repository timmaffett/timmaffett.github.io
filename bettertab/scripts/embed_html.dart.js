...
if(r==null)r="stable"
if(J.j1(B.a7.gC(B.a7),r)){s=t.x.a(A.ah().a6(B.t))
q=B.a7.i(0,r)
q.toString
...
e=A.vZ()
s=6
return A.ap(h.b1("format",f,e,g,t.e0).dZ(0,B.ay),$async$cr)
case 6:k=a0
h=A.f(n.c,"busyLight")
h.b=0
h.cz()
...
break
case 2:s=4
return A.ap(q.f.mC("Show solution?",'If you just want a hint, click <span style="font-weight:bold">Cancel</span> and then <span style="font-weight:bold">Hint</span>.',"Cancel","Show solution",B.ax,B.bA),$async$bO)
...
lE(){var s=window
s.toString
B.ab.eS(s,"message",new A.o7(this),!1)},
$iAa:1}
A.o7.prototype={
...
c=a1.a(l)
b=A.vA()
j=a0.b1("analyze",c,b,a1,t.ye).dZ(0,B.ay)
m.sn_(j)
p=4
s=7
...
c=A.vL()
s=10
return A.ap(d.b1("compileDDC",a,c,b,t.qp).dZ(0,B.az),$async$at)
case 10:j=a8
d=l.giu()
...
c=A.vN()
s=12
return A.ap(d.b1("compile",a,c,b,t.CX).dZ(0,B.az),$async$at)
case 12:i=a8
d=l.giu()
a5.a(A.ah().a6(B.i)).fC("action-perf","compilation-e2e",d)
A.f(m.aX,"consoleExpandController").aA(0)
...
i+=j.eM(a+"  ")
h.a=i
h.a=i+(a+"}\n")}else{if(p.b(j))j=B.aX.fz(j,0,B.ar)
h.a+=a+A.l(n)+": "+A.l(j)+"\n"}}}s=h.a
return s.charCodeAt(0)==0?s:s},
as(){if(this.b)return
...
if(r.e2(q)===0&&p!==0){if(q-s.b===0)return p===r.b.length-1?"":A.fi(B.a9.bT(r.c,r.d1(p),r.d1(p+1)),0,null)}else q=p===r.b.length-1?r.c.length:r.d1(p+1)
...
case B.aj:return p.m9()
case B.bh:return p.ma()
case B.al:return p.mb()
case B.ak:p.c=B.aj
r=p.a.a0()
r=r.gB(r)
r=A.ak(r.a,r.b)
