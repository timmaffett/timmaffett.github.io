...
break
case 2:s=4
return A.ap(q.f.mC("Show solution?",'If you just want a hint, click <span style="font-weight:bold">Cancel</span> and then <span style="font-weight:bold">Hint</span>.',"Cancel","Show solution",B.aw,B.bB),$async$bO)
...
i+=j.eM(a+"  ")
h.a=i
h.a=i+(a+"}\n")}else{if(p.b(j))j=B.aY.fz(j,0,B.aq)
h.a+=a+A.l(n)+": "+A.l(j)+"\n"}}}s=h.a
return s.charCodeAt(0)==0?s:s},
as(){if(this.b)return
...
return p^q}else if(t.R.b(a)){r=B.bn.f4(0,J.bO(a,A.xX(),t.z))
...
dh(a){var s,r,q=this
t.be.a(a)
switch(a.gt(a)){case B.aC:return q.lQ(t.tf.a(a))
case B.aD:t.g9.a(a)
s=a.c
...
return r
case B.aE:return q.lU(t.kA.a(a))
case B.aF:return q.lT(t.qM.a(a))
...
case B.bg:return p.hD(!0)
case B.ai:return p.m9()
case B.bi:return p.ma()
...
case B.bf:return p.hB(!0)
case B.X:return p.m7()
case B.ah:return p.m8()
case B.be:return p.hC(!0)
default:throw A.a("Unreachable")}},
...
return}}}switch(s.Z()){case 91:l.hb(B.b7)
return
case 123:l.hb(B.b4)
return
case 93:l.ha(B.y)
...
l.eI(s.cy,B.b6,A.ak(s.f,s.c))}l.bs()
l.z=!0
l.bB(B.A)}return
