...
zw(a,b,c){return J.fJ(a).fa(a,b,c)},
...
r=a.length
if(c+s>r)c=r-s
return a.lastIndexOf(b,c)}for(s=J.fJ(b),q=c;q>=0;--q)if(s.fa(b,a,q)!=null)return q
return-1},
...
q.a(A.ah().a6(B.u)).cI(B.c0,new A.o4(r),"Completion")
q.a(A.ah().a6(B.u)).cI(B.c3,new A.o5(r),"Quick fix")
q.a(A.ah().a6(B.u)).cI(B.c_,new A.o6(r),"Format")
q=document
q.toString
s=t.hm.a(r.gll())
t.Z.a(null)
...
a1=A.t(e)
b.a.bA(2,a1)
m.it(A.k([b],t.e5))}else m.a.nL(B.bW,f,null,null)
...
s=3
return A.ap(p.c.dt("GET",A.a1(b===B.K?"https://master-api.flutter.dev/snippets/"+a+".dart":"https://api.flutter.dev/snippets/"+a+".dart"),t.n.a(null)),$async$dT)
case 3:o=d
n=o.b
...
if(r.e2(q)===0&&p!==0){if(q-s.b===0)return p===r.b.length-1?"":A.fj(B.a8.bT(r.c,r.d1(p),r.d1(p+1)),0,null)}else q=p===r.b.length-1?r.c.length:r.d1(p+1)
...
case B.Y:return p.mc()
case B.b9:p.a.a1()
return p.hz()
case B.V:return p.hz()
case B.W:return p.m2()
...
n=o.a0()
n.toString}if(s.gt(s)!==B.Q&&s.gt(s)!==B.R&&s.gt(s)!==B.S&&s.gt(s)!==B.x){p.hJ()
B.b.m(p.b,B.ae)
p.c=B.ba
o=s.gB(s)
o=A.ak(o.a,o.b)
...
p=l.mp()
if(p!=null){s=l.f
s.ay(s.$ti.h("af.E").a(p))}return}if(l.df(3)){if(s.au(0,"---")){l.h9(B.S)
...
l.eI(s.cy,B.U,A.ak(s.f,s.c))}l.z=r.length===1
l.bB(B.l)}return
...
B.cl=new A.av(4,{"Cmd-/":"toggleComment","Ctrl-/":"toggleComment","Shift-Tab":"indentLess",Tab:u.m},B.bZ,t.hD)
B.c5=A.k(s(["completeSingle"]),t.s)
B.cp=new A.av(1,{completeSingle:!1},B.c5,t.y5)
B.E=new A.av(12,{continueComments:B.cm,autofocus:!1,autoCloseBrackets:!0,matchBrackets:!0,tabSize:2,lineWrapping:!1,indentUnit:2,cursorHeight:0.85,viewportMargin:100,extraKeys:B.cl,hintOptions:B.cp,scrollbarStyle:"simple"},B.c2,A.au("av<b,o>"))
