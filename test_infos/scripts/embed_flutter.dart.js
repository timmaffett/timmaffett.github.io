...
p.bq(a)
s=p.b|=4
if((s&1)!==0)p.gcG().bW(B.a0)
else if((s&3)===0)p.he().m(0,B.a0)
...
return A.iS(a,b,c,B.Q,!0)}if(d==null)return null
s=new A.ab("")
r.a=""
...
if(s!=null){A.fn(B.a3,new A.pq(s))
return!0}return!1},
...
a3.d=a0
if(r===B.I||q||r===B.J){r=s.querySelector("#console-output-header")
r.toString
...
q.toString
p=k.Q.a
if(p===B.I||p===B.aD){o=s.querySelector(i)
o.toString
n=A.j([o,q],t.k)
...
l=s.querySelector(g)
l.removeAttribute(f)
n=A.j([o,l],q)}m=!0}if(p===B.J){s=s.querySelector(i)
...
s=3
return A.al(p.c.dt("GET",A.a4(b===B.M?"https://master-api.flutter.dev/snippets/"+a+".dart":"https://api.flutter.dev/snippets/"+a+".dart"),t.n.a(null)),$async$dU)
case 3:o=d
n=o.b
...
else if(c===403)throw A.a(A.e3(B.N,null))
...
throw A.a(A.e3(B.O,"Issue parsing metadata: "+A.l(k)))}else if(t.b.b(c)){j=c
throw A.a(A.e3(B.O,"Issue parsing metadata: "+A.l(j)))}else throw a2}c=A.f(m.c,"files")
h=A.a3(c)
s=4
...
case 3:m=c
if(m.b===404)throw A.a(A.e3(B.O,null))
else{o=p.f.b
if(o===403)throw A.a(A.e3(B.N,null))
...
q=this.a
p=q.bm()
for(;p.gu(p)!==B.K;){B.b.m(s,this.dh(p))
...
case B.a_:return p.my()
case B.bc:p.a.a4()
return p.hI()
case B.X:return p.hI()
...
r=A.am(r.a,r.b)
q=r.b
return new A.aI(B.L,A.at(r.a,q,q))
...
n.toString
for(s=n;s.gu(s)===B.V;s=n){o.a4()
n=o.a3()
n.toString}if(s.gu(s)!==B.S&&s.gu(s)!==B.T&&s.gu(s)!==B.U&&s.gu(s)!==B.x){p.hS()
B.b.m(p.b,B.ah)
p.c=B.bd
o=s.gA(s)
o=A.am(o.a,o.b)
...
q=p.hS()
s=o.a3()
if(s.gu(s)!==B.U)throw A.a(A.a0("Expected document start.",s.gA(s)))
B.b.m(p.b,B.ah)
p.c=B.bf
o.a4()
return A.wr(r.aB(0,s.gA(s)),!1,q.b,q.a)},
mq(){var s,r,q=this,p=q.a.a3()
switch(p.gu(p)){case B.S:case B.T:case B.U:case B.V:case B.x:s=q.b
if(0>=s.length)return A.e(s,-1)
q.c=s.pop()
s=p.gA(p)
s=A.am(s.a,s.b)
...
if(b&&q.gu(q)===B.A){n.c=B.a_
return new A.eh(m.c.aB(0,q.gA(q)),m.b,p,B.a1)}if(q instanceof A.dm){if(p==null&&q.c!==B.h)p="!"
k=n.b
if(0>=k.length)return A.e(k,-1)
n.c=k.pop()
l.a4()
return new A.aW(m.c.aB(0,q.a),m.b,p,q.b,q.c)}if(q.gu(q)===B.b9){n.c=B.bi
return new A.eh(m.c.aB(0,q.gA(q)),m.b,p,B.a2)}if(q.gu(q)===B.b6){n.c=B.bh
return new A.eb(m.c.aB(0,q.gA(q)),m.b,p,B.a2)}if(a&&q.gu(q)===B.b8){n.c=B.be
return new A.eh(m.c.aB(0,q.gA(q)),m.b,p,B.a1)}if(a&&q.gu(q)===B.W){n.c=B.bc
return new A.eb(m.c.aB(0,q.gA(q)),m.b,p,B.a1)}if(m.b!=null||p!=null){l=n.b
...
q.c=p.pop()
return new A.aI(B.K,o.gA(o))}p=o.gA(o)
...
p=A.am(p.a,p.b)
s=p.b
return new A.aI(B.K,A.at(p.a,s,s))}s=o.gA(o)
r=A.am(s.a,s.b)
p.a4()
o=p.a3()
if(o.gu(o)===B.A||o.gu(o)===B.m||o.gu(o)===B.n||o.gu(o)===B.t){q.c=B.a_
p=r.b
return new A.aW(A.at(r.a,p,p),null,null,"",B.h)}else{B.b.m(q.b,B.a_)
return q.dk(!0)}},
...
o.a4()
n=o.a3()
if(n.gu(n)===B.m||n.gu(n)===B.n||n.gu(n)===B.t){q.c=B.Y
o=r.b
return new A.aW(A.at(r.a,o,o),p,p,"",B.h)}else{B.b.m(q.b,B.Y)
return q.cw(!0,!0)}}if(n.gu(n)===B.n){q.c=B.Y
o=n.gA(n)
o=A.am(o.a,o.b)
s=o.b
...
s.a4()
return new A.eb(r.gA(r),null,null,B.a2)}else if(r.gu(r)!==B.y){B.b.m(p.b,B.al)
return p.bI()}}s.a4()
s=p.b
if(0>=s.length)return A.e(s,-1)
p.c=s.pop()
...
s=p.a3()
if(s.gu(s)!==B.r&&s.gu(s)!==B.z){B.b.m(r.b,B.Z)
...
r=l
q=null
while(!0){if(!(r.gu(r)===B.S||r.gu(r)===B.T))break
...
p=l.mM()
if(p!=null){s=l.f
s.ax(s.$ti.h("ah.E").a(p))}return}if(l.df(3)){if(s.au(0,"---")){l.hi(B.U)
return}if(s.au(0,"...")){l.hi(B.V)
...
l.eL(s.cy,B.W,A.am(s.f,s.c))}l.z=r.length===1
l.bG(B.m)}return
...
B.bE=new A.c6(32e3)
B.aC=new A.c6(6e7)
B.I=new A.eV("flutter")
B.aD=new A.eV("html")
B.bF=new A.eV("inline")
B.J=new A.eV("flutter_showcase")
...
B.N=new A.f_("rateLimitExceeded")
B.aP=new A.dc(B.N,null)
B.O=new A.f_("invalidExerciseMetadata")
B.bS=new A.jS(null)
B.bT=new A.jT(null)
B.bU=new A.jW(!1,255)
B.aQ=new A.jX(255)
...
B.P=A.j(s([0,0,32776,33792,1,10240,0,0]),t.t)
...
B.Q=A.j(s([0,0,65490,45055,65535,34815,65534,18431]),t.t)
...
B.R=A.j(s([0,0,26624,1023,65534,2047,65534,2047]),t.t)
...
B.bM=new A.eZ("error")
B.ab=new A.e1([B.aJ,"flash-warn",B.bM,"flash-error",B.aK,"flash-success"],A.ax("e1<eZ,b>"))
B.d8=new A.kj("")
...
B.cG=new A.aE("tag")
B.S=new A.aE("versionDirective")
B.b7=new A.aE("scalar")
B.T=new A.aE("tagDirective")
B.U=new A.aE("documentStart")
B.V=new A.aE("documentEnd")
B.b8=new A.aE("blockSequenceStart")
B.W=new A.aE("blockMappingStart")
...
B.X=new A.au("BLOCK_MAPPING_KEY")
B.Y=new A.au("BLOCK_MAPPING_VALUE")
...
B.a_=new A.au("INDENTLESS_SEQUENCE_ENTRY")
